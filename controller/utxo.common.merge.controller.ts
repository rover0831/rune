...
export const mergeUTXOPsbt = (wallet: any, utxos: IUtxo[], networkType: string, mergeCount: number, fee: number | undefined, receiveAddress: string, receiveAmount: number): Bitcoin.Psbt => {
    let value = 0;
